...
type IconType = "shopping-cart" | "arrow-down" | "arrow-right" | "lens" | "star-filled" | "star-border" | "heart-filled" | "heart-border" 
  | "pen" | "income" | "shopping-bag" | "bell" | "mail" | "info";
type ColorType = "gray" | "orange";
type Icon = {type: IconType; color: ColorType};
  
export default function Basket({type, color}: Icon){
  ...
  switch (type) {
        ...
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="19.914" height="19.914" viewBox="0 0 19.914 19.914" className={color === "gray"?'stroke-icongray-100':'stroke-iconorange-100'}>
            <g id="Group_6821" data-name="Group 6821" transform="translate(-13 -13)">
              <g id="Ellipse_16" data-name="Ellipse 16" transform="translate(13 13)"   stroke-width="2">
                <circle cx="8.5" cy="8.5" r="8.5" className='stroke-none'/>
                <circle cx="8.5" cy="8.5" r="7.5" />
              </g>
              <line id="Line_3" data-name="Line 3" x2="4" y2="4" transform="translate(27.5 27.5)"  stroke-linecap="round" stroke-width="2"/>
            </g>
          </svg>
        </span>
      );
      ...
      content = (
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="20.112" height="16.717" viewBox="0 0 20.112 16.717">
            <path id="Path_8609" data-name="Path 8609" d="M13.913,35.525a5.224,5.224,0,0,1,5.2,5.2c0,5.249-9.556,10.448-9.556,10.448S0,45.9,0,40.723a5.2,5.2,0,0,1,5.2-5.2h0a5.147,5.147,0,0,1,4.357,2.344A5.2,5.2,0,0,1,13.913,35.525Z" transform="translate(0.5 -35.025)"  stroke="#fc6011" stroke-width="1"/>
          </svg>
        </span>
      );
      break;
    case "heart-border":
      content = (
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="20.112" height="16.717" viewBox="0 0 20.112 16.717">
            <path id="Path_10234" data-name="Path 10234" d="M13.913,35.525a5.224,5.224,0,0,1,5.2,5.2c0,5.249-9.556,10.448-9.556,10.448S0,45.9,0,40.723a5.2,5.2,0,0,1,5.2-5.2h0a5.147,5.147,0,0,1,4.357,2.344A5.2,5.2,0,0,1,13.913,35.525Z" transform="translate(0.5 -35.025)"  stroke="#fc6011" stroke-width="1"/>
          </svg>
        </span>
      );
      break;
      ...
      content = (
        <span>
          <svg id="Group_1894" data-name="Group 1894" xmlns="http://www.w3.org/2000/svg" width="10.813" height="10.813" viewBox="0 0 10.813 10.813">
    ...
    case "income":
      content = (
        <span>
          <svg id="_002-income" data-name="002-income" xmlns="http://www.w3.org/2000/svg" width="29.197" height="29.607" viewBox="0 0 29.197 29.607">
    ...
    case "shopping-bag":
      content = (
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="18.548" height="21.584" viewBox="0 0 18.548 21.584">
    ...
    case "bell":
      content = (
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="17.727" height="22.367" viewBox="0 0 17.727 22.367">
    ...
    case "mail":
      content = (
        <span>
          <svg id="_004-inbox-mail" data-name="004-inbox-mail" xmlns="http://www.w3.org/2000/svg" width="21.727" height="15.452" viewBox="0 0 21.727 15.452">
    ...
    case "info":
      content = (
        <span>
          <svg id="_005-info" data-name="005-info" xmlns="http://www.w3.org/2000/svg" width="11.434" height="25.877" viewBox="0 0 11.434 25.877">
