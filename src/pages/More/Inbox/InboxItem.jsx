    ...
    return (
        <div className="flex items-start justify-between gap-[5px] pt-[14px] h-[88px] border-b-1px border-[#eeeeee]">
            ...
            <div className="flex flex-col basis-[90%] gap-1">
                ...
                <p className="text-sm text-placeholder h-[20px] overflow-hidden">{content}</p>
            </div>
            <div className="flex flex-col w-[40px] items-end justify-between h-[80%]" onClick={() => setLike(!like)}>
